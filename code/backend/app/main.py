...
from app.services.liveavatar import log_startup_env_hint
...
async def http_exception_handler(request: Request, exc: StarletteHTTPException):
    ...
    # Ficheros bajo /uploads: StaticFiles lanza 404 si no existe el archivo; no devolver JSON
    # (el navegador en <img src> no debe recibir application/json).
    if exc.status_code == 404 and request.url.path.startswith("/uploads"):
        resp = Response(status_code=404, headers=headers)
