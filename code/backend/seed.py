...
# Cargos (diseño de contenido: cargos.json + Context Dinamico roles-data)
    if db.query(JobRole).count() == 0:
        ...
        for r in roles:
            db.add(r)
        db.flush()
# Casos (diseño de contenido: indicaciones.json, mapeo: baja->apoyo_regulacion, media->alta_estructuracion, alta->exigencia_alta)
