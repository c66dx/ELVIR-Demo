...
@Component({
  selector: 'app-interview-waiting-room',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './interview-waiting-room.component.html',
  styleUrl: './interview-waiting-room.component.scss',
})
export class InterviewWaitingRoomComponent implements OnInit, OnDestroy {
  ...
  loadingMessages = [
    'La entrevistadora está ingresando a la sala…',
    'Revisando antecedentes del cargo…',
    'Verificando audio y video…',
    'La entrevista comenzará en unos segundos…',
  ];
