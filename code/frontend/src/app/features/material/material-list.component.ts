...
export class MaterialListComponent {
  ...
  materials$ = this.page$.pipe(
    switchMap((page) => this.api.getSupportMaterialPaged({ page, page_size: this.pageSize }))
  );
  ...
  materialSummary(material: SupportMaterial): string {
    ...
    if (material.type === 'VIDEO') {
      return 'Guia audiovisual para reforzar habilidades clave de entrevista.';
    }
    if (material.type === 'PDF') {
      return 'Resumen descargable con recomendaciones y ejemplos practicos.';
    }
