...
export class ChangePasswordComponent {
  ...
  readonly newPasswordHint = `Mínimo ${environment.passwordMinLength} caracteres`;

  form: FormGroup = this.fb.nonNullable.group({
    current_password: ["", Validators.required],
    new_password: ["", [Validators.required, Validators.minLength(environment.passwordMinLength)]],
