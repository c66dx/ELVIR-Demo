...
import type { Session } from '../../../core/models/session.model'; 
 ...
 @Component({ 
 selector: 'app-session-view',   standalone: true,   imports: [   RouterLink,   ReactiveFormsModule,   StatusBadgeComponent,   FormGridComponent,   FormFieldComponent,   FormActionsComponent,   TextInputComponent,   TextareaInputComponent,   ],   templateUrl: './session-view.component.html',   styleUrl: './session-view.component.scss',   })
