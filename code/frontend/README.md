...
Contrato del backend (rutas, códigos de error): [`../../docs/api/endpoints.md`](../../docs/api/endpoints.md) (**v1.3**).
...
- Configuración base de test:
  - `karma.conf.cjs` (umbrales mínimos de cobertura global para CI; subirlos al añadir tests)
  - `tsconfig.spec.json`
  - `src/test.ts`
