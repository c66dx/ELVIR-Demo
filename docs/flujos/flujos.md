...
**Contratos HTTP:** ver `docs/api/endpoints.md` (versión actual v1.3) para rutas de sesión, salud del servicio y material.
...
- El backend obtiene el prompt (desde JOB_ROLES + CASES / contenido de diseño), hace PATCH al contexto en LiveAvatar, crea la sesión y devuelve token/URL al frontend. 16 plantillas (4 cargos × 4 casos). Ver `docs/liveavatar/integracion-liveavatar.md` y `docs/modelo-datos/flowchart-liveavatar.mmd`.
